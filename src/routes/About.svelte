<script>
    import { Divider, Flex, Text } from "$volt";
</script>
...
<style>
    .about {
        max-width: var(--v-breakpoint-xl);
        margin: auto;
        padding: 12rem var(--v-space-2xl);
    }
    ...
    .skill {
        padding: var(--v-space-m) var(--v-space-l);
